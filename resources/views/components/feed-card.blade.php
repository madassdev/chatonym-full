<div class="feed rounded-xl bg-cha-secondary m-3 my-1 p-3 hidden" id="feed-placeholder">
    <div class="feed-body mb-1 max-sh-40 zoverflow-hidden relative">
        ...
        <div class="image cursor-pointer my-2 w-5/6 m:w-2/3 mx-auto flex items-center justify-center hiddesn">
            <img src="{{asset('img/placeholders/smileys.jpg')}}" class="rounded-2xl feed-img object-cover h-44 w-full" alt="" srcset="" />
        </div>
    ...
    <div class="w-full my-2 text-xs text-gray-600 mx-auto feed-footer flex items-center space-x-8 px-3">
        <div class="reactions">
            <div class="flex items-center text-lg text-cha-primary space-x-1">
                <p class="reaction-emojis">😅😂😡
    ...
    <div class="feed-replies">
        <p class="replies-count text-cha-primary text-xs mx-4">
            3 Replies
        </p>
        <div class="replies-container hidden flex flex-col space-y-2">
            <div class="reply w-5/6 mx-auto px-4  my-1 border-l border-gray-300">
                <p class="font-light truncate-2 text-gray-500 text-xs-12 leading-1 reply-text">
                ...
                <p class="font-light text-gray-400 text-xs-10">
                    <i class="mdi mdi-circle text-gray-400 text-xs-8"></i>
